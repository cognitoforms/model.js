// let d1 = new Date(2019, 1, 13, 11, 26, 34);
...
describe("globalize.culture", function() {
...
describe("globalize.formatDate", function() {
...
describe("globalize.parseDate", function() {
...
describe("globalize.formatNumber", () => {
    test("formatNumber(#, 'n'", () => {
...
describe("globalize.parseNumber", () => {
    test("parseNumber('#.##')", () => {
